...
public class Reservacion implements Serializable {
    ...
    public Reservacion(String nombre, String apellidoPaterno, String email, Collection<Destino> destinoCollection, Collection<Tarjeta> tarjetaCollection) {
        this.nombre = nombre;
    ...
    public String toString() {
        return "Model.Reservacion[ idReservacion=" + idReservacion + " ]";
    }
